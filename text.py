...
ulica='Staszica'
bold_ulica=f'\033[1m{ulica}\033[0m'
imie=''
nazwisko=''
firma=''

def body(imie, nazwisko, firma):
    body= f"""Szanowny Panie {imie}
    \n 
    {nazwisko} Pragniemy poinformować, że w Domu przy {bold_ulica} w sprzedaży zostały ostatnie wolne mieszkania.Nasza nowa inwestycja to kameralny budynek położony na południu Krakowa, w bezpośrednim sąsiedztwie prawie dziesięciohektarowego Parku Lilli Wenedy.
